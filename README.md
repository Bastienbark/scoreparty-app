...
Aucun autre écran (Accueil, Setup, Historique, Stats, Règles) n'a besoin d'être modifié : ils lisent tous le registre de jeux dynamiquement. C'est exactement comme ça que Skyjo a été ajouté après le lancement initial.
